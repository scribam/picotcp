...
static const struct pico_ppp_fsm ppp_modem_fsm[PPP_MODEM_STATE_MAX][PPP_MODEM_EVENT_MAX] = {
    [PPP_MODEM_STATE_INITIAL] = {
        ...
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_INITIAL, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_RESET] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_RESET, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_ECHO, { ppp_modem_send_echo } },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_RESET, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_ECHO] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_ECHO, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_CREG, { ppp_modem_send_creg } },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_ECHO, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_CREG] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_CREG, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_CGREG, { ppp_modem_send_cgreg } },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_CREG, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_CGREG] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_CGREG, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_CGDCONT, { ppp_modem_send_cgdcont } },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_CGREG, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_CGDCONT] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_CGDCONT, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_CGATT, { ppp_modem_send_cgatt } },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_CGDCONT, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_CGATT] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_CGATT, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_DIAL, { ppp_modem_send_dial } },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_CGATT, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_DIAL] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_DIAL, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, {0} },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_DIAL, {0} },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_CONNECTED, { ppp_modem_connected } },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_RESET, {ppp_modem_send_reset} }
    },
    [PPP_MODEM_STATE_CONNECTED] = {
        [PPP_MODEM_EVENT_START]   = { PPP_MODEM_STATE_CONNECTED, {0} },
        [PPP_MODEM_EVENT_STOP]    = { PPP_MODEM_STATE_INITIAL, { ppp_modem_disconnected } },
        [PPP_MODEM_EVENT_OK]      = { PPP_MODEM_STATE_CONNECTED, {0} },
        [PPP_MODEM_EVENT_CONNECT] = { PPP_MODEM_STATE_CONNECTED, {0} },
        [PPP_MODEM_EVENT_TIMEOUT] = { PPP_MODEM_STATE_CONNECTED, {0} }
    }
};
static void evaluate_modem_state(struct pico_device_ppp *ppp, enum ppp_modem_event event)
{
...
static const struct pico_ppp_fsm ppp_lcp_fsm[PPP_LCP_STATE_MAX][PPP_LCP_EVENT_MAX] = {
    [PPP_LCP_STATE_INITIAL] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_CLOSED, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_STARTING, { lcp_this_layer_started } },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_TO_POS]  = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_TO_NEG]  = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RCR_POS] = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RCR_NEG] = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RCA]     = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RCN]     = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RTR]     = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RTA]     = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RUC]     = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_INITIAL, {0} }
    },
    [PPP_LCP_STATE_STARTING] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_REQ_SENT, {  lcp_send_configure_request } },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_INITIAL, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_TO_POS]  = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_TO_NEG]  = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RCR_POS] = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RCR_NEG] = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RCA]     = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RCN]     = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RTR]     = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RTA]     = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RUC]     = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_STARTING, {0} }
    },
    [PPP_LCP_STATE_CLOSED] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_CLOSED, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_REQ_SENT, { lcp_send_configure_request} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSED, {0} },
        [PPP_LCP_EVENT_TO_POS]  = { PPP_LCP_STATE_CLOSED, {0} },
        [PPP_LCP_EVENT_TO_NEG]  = { PPP_LCP_STATE_CLOSED, {0} },
        ...
        [PPP_LCP_EVENT_RTA]     = { PPP_LCP_STATE_CLOSED, {0} },
        [PPP_LCP_EVENT_RUC]     = { PPP_LCP_STATE_CLOSED, { lcp_send_code_reject } },
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_CLOSED, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_CLOSED, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_CLOSED, {0} }
    },
    [PPP_LCP_STATE_STOPPED] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_STOPPED, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, { lcp_this_layer_started } },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_STOPPED, {0}},
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSED, {0}},
        [PPP_LCP_EVENT_TO_POS]  = { PPP_LCP_STATE_STOPPED, {0} },
        [PPP_LCP_EVENT_TO_NEG]  = { PPP_LCP_STATE_STOPPED, {0} },
        ...
        [PPP_LCP_EVENT_RTA]     = { PPP_LCP_STATE_STOPPED, {0} },
        [PPP_LCP_EVENT_RUC]     = { PPP_LCP_STATE_STOPPED, { lcp_send_code_reject } },
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_STOPPED, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_STOPPED, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_STOPPED, {0} }
    },
    [PPP_LCP_STATE_CLOSING] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_CLOSING, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_INITIAL, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSING, {0} },
        ...
        [PPP_LCP_EVENT_RCR_POS] = { PPP_LCP_STATE_CLOSING, {0} },
        [PPP_LCP_EVENT_RCR_NEG] = { PPP_LCP_STATE_CLOSING, {0} },
        [PPP_LCP_EVENT_RCA]     = { PPP_LCP_STATE_CLOSING, {0} },
        [PPP_LCP_EVENT_RCN]     = { PPP_LCP_STATE_CLOSING, {0} },
        ...
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_CLOSING, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_CLOSED, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_CLOSING, {0} }
    },
    [PPP_LCP_STATE_STOPPING] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSING, {0} },
        ...
        [PPP_LCP_EVENT_RCR_POS] = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_RCR_NEG] = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_RCA]     = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_RCN]     = { PPP_LCP_STATE_STOPPING, {0} },
        ...
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_STOPPING, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_STOPPED, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_STOPPING, {0} }
    },
    [PPP_LCP_STATE_REQ_SENT] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_REQ_SENT, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_REQ_SENT, {0} },
        ...
        [PPP_LCP_EVENT_RTA]     = { PPP_LCP_STATE_REQ_SENT, {0} },
        [PPP_LCP_EVENT_RUC]     = { PPP_LCP_STATE_REQ_SENT, { lcp_send_code_reject } },
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_REQ_SENT, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_STOPPED, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_REQ_SENT, {0} }
    },
    [PPP_LCP_STATE_ACK_RCVD] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_ACK_RCVD, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_ACK_RCVD, {0} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSING,  {  lcp_send_terminate_request} },
        [PPP_LCP_EVENT_TO_POS]  = { PPP_LCP_STATE_REQ_SENT, { lcp_send_configure_request } },
        [PPP_LCP_EVENT_TO_NEG]  = { PPP_LCP_STATE_STOPPED,  { lcp_this_layer_finished } },
        ...
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_REQ_SENT, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_STOPPED,  { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_ACK_RCVD, {0} }
    },
    [PPP_LCP_STATE_ACK_SENT] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_ACK_SENT, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, {0} },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_ACK_SENT, {0} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSING,  { lcp_send_terminate_request} },
        ...
        [PPP_LCP_EVENT_RTR]     = { PPP_LCP_STATE_REQ_SENT, { lcp_send_terminate_ack } },
        [PPP_LCP_EVENT_RTA]     = { PPP_LCP_STATE_ACK_SENT, {0} },
        [PPP_LCP_EVENT_RUC]     = { PPP_LCP_STATE_ACK_SENT, { lcp_send_code_reject } },
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_ACK_SENT, {0} },
        [PPP_LCP_EVENT_RXJ_NEG] = { PPP_LCP_STATE_STOPPED, { lcp_this_layer_finished } },
        [PPP_LCP_EVENT_RXR]     = { PPP_LCP_STATE_ACK_SENT, {0} }
    },
    [PPP_LCP_STATE_OPENED] = {
        [PPP_LCP_EVENT_UP]      = { PPP_LCP_STATE_OPENED, {0} },
        [PPP_LCP_EVENT_DOWN]    = { PPP_LCP_STATE_STARTING, {lcp_this_layer_down } },
        [PPP_LCP_EVENT_OPEN]    = { PPP_LCP_STATE_OPENED, {0} },
        [PPP_LCP_EVENT_CLOSE]   = { PPP_LCP_STATE_CLOSING,
                                    { lcp_this_layer_down, lcp_send_terminate_request }},
        [PPP_LCP_EVENT_TO_POS]  = { PPP_LCP_STATE_OPENED, {0} },
        [PPP_LCP_EVENT_TO_NEG]  = { PPP_LCP_STATE_OPENED, {0} },
        [PPP_LCP_EVENT_RCR_POS] = { PPP_LCP_STATE_ACK_SENT,
        ...
        [PPP_LCP_EVENT_RXJ_POS] = { PPP_LCP_STATE_OPENED,   {0} },
...
static const struct pico_ppp_fsm ppp_auth_fsm[PPP_AUTH_STATE_MAX][PPP_AUTH_EVENT_MAX] = {
    [PPP_AUTH_STATE_INITIAL] = {
        ...
        [PPP_AUTH_EVENT_UP_CHAP] = { PPP_AUTH_STATE_STARTING, {0} },
        [PPP_AUTH_EVENT_DOWN]    = { PPP_AUTH_STATE_INITIAL, {0} },
        [PPP_AUTH_EVENT_RAC]     = { PPP_AUTH_STATE_INITIAL, {0} },
        [PPP_AUTH_EVENT_RAA]     = { PPP_AUTH_STATE_INITIAL, {0} },
        [PPP_AUTH_EVENT_RAN]     = { PPP_AUTH_STATE_INITIAL, {auth_abort} },
        [PPP_AUTH_EVENT_TO]     =  { PPP_AUTH_STATE_INITIAL, {0} }
    },
    [PPP_AUTH_STATE_STARTING] = {
        [PPP_AUTH_EVENT_UP_NONE] = { PPP_AUTH_STATE_STARTING, {0} },
        [PPP_AUTH_EVENT_UP_PAP]  = { PPP_AUTH_STATE_STARTING, {0} },
        [PPP_AUTH_EVENT_UP_CHAP] = { PPP_AUTH_STATE_STARTING, {0} },
    ...
    [PPP_AUTH_STATE_RSP_SENT] = {
        [PPP_AUTH_EVENT_UP_NONE] = { PPP_AUTH_STATE_RSP_SENT, {0} },
        [PPP_AUTH_EVENT_UP_PAP]  = { PPP_AUTH_STATE_RSP_SENT, {0} },
        [PPP_AUTH_EVENT_UP_CHAP] = { PPP_AUTH_STATE_RSP_SENT, {0} },
        [PPP_AUTH_EVENT_DOWN]    = { PPP_AUTH_STATE_INITIAL, {deauth} },
        [PPP_AUTH_EVENT_RAC]     = { PPP_AUTH_STATE_RSP_SENT, {auth_rsp, auth_start_timer} },
    ...
    [PPP_AUTH_STATE_REQ_SENT] = {
        [PPP_AUTH_EVENT_UP_NONE] = { PPP_AUTH_STATE_REQ_SENT, {0} },
        [PPP_AUTH_EVENT_UP_PAP]  = { PPP_AUTH_STATE_REQ_SENT, {0} },
        [PPP_AUTH_EVENT_UP_CHAP] = { PPP_AUTH_STATE_REQ_SENT, {0} },
        [PPP_AUTH_EVENT_DOWN]    = { PPP_AUTH_STATE_INITIAL, {deauth} },
        [PPP_AUTH_EVENT_RAC]     = { PPP_AUTH_STATE_REQ_SENT, {0} },
        [PPP_AUTH_EVENT_RAA]     = { PPP_AUTH_STATE_AUTHENTICATED, {auth} },
        [PPP_AUTH_EVENT_RAN]     = { PPP_AUTH_STATE_REQ_SENT, {auth_abort} },
        [PPP_AUTH_EVENT_TO]     =  { PPP_AUTH_STATE_REQ_SENT, {auth_req, auth_start_timer} }
    },
    [PPP_AUTH_STATE_AUTHENTICATED] = {
        [PPP_AUTH_EVENT_UP_NONE] = { PPP_AUTH_STATE_AUTHENTICATED, {0} },
        [PPP_AUTH_EVENT_UP_PAP]  = { PPP_AUTH_STATE_AUTHENTICATED, {0} },
        [PPP_AUTH_EVENT_UP_CHAP] = { PPP_AUTH_STATE_AUTHENTICATED, {0} },
        [PPP_AUTH_EVENT_DOWN]    = { PPP_AUTH_STATE_INITIAL, {deauth} },
        [PPP_AUTH_EVENT_RAC]     = { PPP_AUTH_STATE_RSP_SENT, {auth_rsp} },
        [PPP_AUTH_EVENT_RAA]     = { PPP_AUTH_STATE_AUTHENTICATED, {0} },
        [PPP_AUTH_EVENT_RAN]     = { PPP_AUTH_STATE_AUTHENTICATED, {0} },
        [PPP_AUTH_EVENT_TO]      = { PPP_AUTH_STATE_AUTHENTICATED, {0} },
    }
};
...
static const struct pico_ppp_fsm ppp_ipcp_fsm[PPP_IPCP_STATE_MAX][PPP_IPCP_EVENT_MAX] = {
    [PPP_IPCP_STATE_INITIAL] = {
        ...
        [PPP_IPCP_EVENT_DOWN]    = { PPP_IPCP_STATE_INITIAL, {0} },
        [PPP_IPCP_EVENT_RCR_POS] = { PPP_IPCP_STATE_INITIAL, {0} },
        [PPP_IPCP_EVENT_RCR_NEG] = { PPP_IPCP_STATE_INITIAL, {0} },
        [PPP_IPCP_EVENT_RCA]     = { PPP_IPCP_STATE_INITIAL, {0} },
        [PPP_IPCP_EVENT_RCN]     = { PPP_IPCP_STATE_INITIAL, {0} },
        [PPP_IPCP_EVENT_TO]      = { PPP_IPCP_STATE_INITIAL, {0} }
    },
    [PPP_IPCP_STATE_REQ_SENT] = {
        [PPP_IPCP_EVENT_UP]      = { PPP_IPCP_STATE_REQ_SENT, {0} },
        [PPP_IPCP_EVENT_DOWN]    = { PPP_IPCP_STATE_INITIAL, {0} },
        ...
        [PPP_IPCP_EVENT_RCA]     = { PPP_IPCP_STATE_ACK_RCVD, {0} },
    ...
    [PPP_IPCP_STATE_ACK_RCVD] = {
        [PPP_IPCP_EVENT_UP]      = { PPP_IPCP_STATE_ACK_RCVD, {0} },
        [PPP_IPCP_EVENT_DOWN]    = { PPP_IPCP_STATE_INITIAL, {0} },
    ...
    [PPP_IPCP_STATE_ACK_SENT] = {
        [PPP_IPCP_EVENT_UP]      = { PPP_IPCP_STATE_ACK_SENT, {0} },
        [PPP_IPCP_EVENT_DOWN]    = { PPP_IPCP_STATE_INITIAL, {0} },
        [PPP_IPCP_EVENT_RCR_POS] = { PPP_IPCP_STATE_ACK_SENT, {ipcp_send_ack} },
        [PPP_IPCP_EVENT_RCR_NEG] = { PPP_IPCP_STATE_REQ_SENT, {ipcp_send_nack} },
    ...
    [PPP_IPCP_STATE_OPENED] = {
        [PPP_IPCP_EVENT_UP]      = { PPP_IPCP_STATE_OPENED, {0} },
        ...
        [PPP_IPCP_EVENT_TO]      = { PPP_IPCP_STATE_OPENED, {0} }
    }
};
